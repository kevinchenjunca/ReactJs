...
var normalizeHeaderName = __webpack_require__(528);
...
var _deepEqual = __webpack_require__(329);
...
var _createLocation2 = __webpack_require__(333);
...
var _useBasename = __webpack_require__(172);
...
var _useRouterHistory = __webpack_require__(173);
...
var buildURL = __webpack_require__(531);
var parseHeaders = __webpack_require__(532);
var isURLSameOrigin = __webpack_require__(533);
var createError = __webpack_require__(205);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(534);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(535);
...
var enhanceError = __webpack_require__(530);
...
var _signout = __webpack_require__(543);

var _signout2 = _interopRequireDefault(_signout);

var _signup = __webpack_require__(544);

var _signup2 = _interopRequireDefault(_signup);

var _feature = __webpack_require__(545);

var _feature2 = _interopRequireDefault(_feature);

var _require_authentication = __webpack_require__(546);

var _require_authentication2 = _interopRequireDefault(_require_authentication);

var _welcome = __webpack_require__(547);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouter.Route, { path: 'feature', component: (0, _require_authentication2.default)(_feature2.default) })
    )
  )
...
var objectKeys = __webpack_require__(330);
...
var _Redirect = __webpack_require__(170);
...
var _createRouterHistory = __webpack_require__(174);
  ...
  _createClass(Signin, [{
    ...
    value: function renderField(field) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({}, field.input, { type: field.type, className: 'form-control' }))
      );
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reduxForm.Field, { name: 'email', label: 'Email:', type: 'text', component: this.renderField }),
        _react2.default.createElement(_reduxForm.Field, { name: 'password', label: 'Password:', type: 'password', component: this.renderField }),
        _react2.default.createElement(
          'button',
...
exports.default = (0, _reduxForm.reduxForm)({
  form: 'SigninForm'
})((0, _reactRedux.connect)(mapStateToProps, { signinUser: _actions.signinUser })(Signin));
...
var utils = __webpack_require__(15);
var bind = __webpack_require__(203);
var Axios = __webpack_require__(527);
...
axios.CancelToken = __webpack_require__(541);
...
axios.spread = __webpack_require__(542);
...
var defaults = __webpack_require__(117);
var utils = __webpack_require__(15);
var InterceptorManager = __webpack_require__(536);
var dispatchRequest = __webpack_require__(537);
var isAbsoluteURL = __webpack_require__(539);
var combineURLs = __webpack_require__(540);
...
var utils = __webpack_require__(15);
var transformData = __webpack_require__(538);
  ...
  _createClass(Signup, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reduxForm.Field, { name: 'email', label: 'Email:', type: 'text', component: this.renderField }),
        _react2.default.createElement(_reduxForm.Field, { name: 'password', label: 'Password:', type: 'password', component: this.renderField }),
        _react2.default.createElement(_reduxForm.Field, { name: 'passwordConfirm', label: 'Confirm Password:', type: 'password', component: this.renderField }),
        _react2.default.createElement(
          'button',
          { action: 'submit', className: 'btn btn-primary' },
          'Sign up'
...
var _auth_reducer = __webpack_require__(549);
...
var _IndexLink2 = __webpack_require__(342);

var _IndexLink3 = _interopRequireDefault(_IndexLink2);

var _withRouter2 = __webpack_require__(343);

var _withRouter3 = _interopRequireDefault(_withRouter2);

var _IndexRedirect2 = __webpack_require__(344);

var _IndexRedirect3 = _interopRequireDefault(_IndexRedirect2);

var _IndexRoute2 = __webpack_require__(345);

var _IndexRoute3 = _interopRequireDefault(_IndexRoute2);

var _Redirect2 = __webpack_require__(170);

var _Redirect3 = _interopRequireDefault(_Redirect2);

var _Route2 = __webpack_require__(346);

var _Route3 = _interopRequireDefault(_Route2);

var _History2 = __webpack_require__(347);

var _History3 = _interopRequireDefault(_History2);

var _Lifecycle2 = __webpack_require__(348);
...
var _useRouterHistory2 = __webpack_require__(173);

var _useRouterHistory3 = _interopRequireDefault(_useRouterHistory2);

var _applyRouterMiddleware2 = __webpack_require__(354);

var _applyRouterMiddleware3 = _interopRequireDefault(_applyRouterMiddleware2);

var _browserHistory2 = __webpack_require__(355);

var _browserHistory3 = _interopRequireDefault(_browserHistory2);

var _hashHistory2 = __webpack_require__(357);
...
var _getRouteParams = __webpack_require__(341);
...
var ROOT_URL = 'https://immense-eyrie-53445.herokuapp.com';
...
function signupUser(_ref2) {
  ...
  return function (dispatch) {
    ...
    _axios2.default.post(ROOT_URL + '/signup', { email: email, password: password }).then(function (response) {
      ...
      return dispatch(authError(response.response.data.error));
    });
  };
}
...
var _getComponents = __webpack_require__(339);
